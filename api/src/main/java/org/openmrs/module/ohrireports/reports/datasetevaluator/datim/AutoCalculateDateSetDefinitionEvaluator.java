...
@Handler(supports = { AutoCalculateDateSetDefinition.class })
public class AutoCalculateDateSetDefinitionEvaluator implements DataSetEvaluator {

    private EvaluationContext context;

    private AutoCalculateDateSetDefinition hdsd;
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        hdsd = (AutoCalculateDateSetDefinition) dataSetDefinition;
        context = evalContext;
        artConcept = conceptService.getConceptByUuid(ART_START_DATE);

        DataSetRow dataSet = new DataSetRow();
        dataSet.addColumnValue(new DataSetColumn("adultAndChildrenEnrolled","Numerator",Integer.class), getTotalEnrolledPatients());
